...
{
    public class PixelRuntimeDataModule : PixelBlackboardModule
    {
        #region Fields
        #region Public
        public const string moduleKey = "PixelBlackboardModule_RuntimeData";
        #endregion //Public
        ...
        public override string ModuleKey => PixelRuntimeDataModule.moduleKey;
