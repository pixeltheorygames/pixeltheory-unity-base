...
{
    public class PixelBehaviour<TypePixelBehaviour> : MonoBehaviour where TypePixelBehaviour : PixelBehaviour<TypePixelBehaviour>
    {
        #region Class
        #region Fields
        #region Private
    ...
    public class PixelBehaviour<TypePixelBehaviour, TypeRuntimeData> : PixelBehaviour<TypePixelBehaviour> 
        where TypePixelBehaviour : PixelBehaviour<TypePixelBehaviour>
        where TypeRuntimeData : RuntimeData<TypeRuntimeData>
    {
        #region Instance
        #region Fields
        #region Inspector
